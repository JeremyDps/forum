        ...
        <div class="text-block">
            <form class="offset-lg-3 col-lg-6" method="post" action="../classes/essai.php">
                <div class="form-group">
                    ...
                    <input type="text" name="nom" class="form-control" aria-describedby="emailHelp" placeholder="Nom du topic">
                </div>
                <div class="form-group">
                    <label name="desc">Description</label>
                    <input type="text" name="desc" class="form-control" aria-describedby="emailHelp" placeholder="Description"><br>
                </div>
                <div class="form-group">
